...
<meta name="twitter:description" content="通報に対する対応には、調査事項のすり替え、調査結果の隠蔽、不適切な情報提供といった複数の問題が存在しました。">
...
<meta property="og:description" content="通報に対する対応には、調査事項のすり替え、調査結果の隠蔽、不適切な情報提供といった複数の問題が存在しました。">
